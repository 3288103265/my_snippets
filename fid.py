...
Clone from:  https://github.com/bioinf-jku/TTUR/edit/master/fid.py
'''
...
def calculate_activation_statistics_from_files(files,
                                               sess,
                                               batch_size=50,
                                               verbose=False):
    """Calculation of the statistics used by the FID.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        nargs=2,
        help='Path to the generated images or to .npz statistic files. Two paths are needed for comparsion.')
    parser.add_argument(
        "-i",
        "--inception",
        type=str,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=
        'Keep only one batch of images in memory at a time. This reduces memory footprint, but may decrease speed slightly.'
    )
